 ...
 * @author hasalp
 */
public class courses_gui_nA extends javax.swing.JFrame {
    ...
    public void search(String search_element){
        ...
        try {
            ...
            while(rs.next()){
                if(String.valueOf(rs.getInt("ders_id")).contains(search_element) || rs.getString("ders_ismi").contains(search_element) || rs.getString("ders_ogretmeni").contains(search_element) || String.valueOf(rs.getFloat("ders_suresi")).contains(search_element) || String.valueOf(rs.getInt("ders_kredisi")).contains(search_element) || rs.getString("ders_sinifi").contains(search_element)||String.valueOf(rs.getInt("bolum_id")).contains(search_element)||String.valueOf(rs.getInt("ders_donemi")).contains(search_element)){
                    model.addRow(new Object[]{
                        rs.getInt("ders_id"),
                        rs.getString("ders_ismi"),
                        rs.getInt("ders_ogretmeni"),
                        rs.getFloat("ders_suresi"),
                        rs.getInt("ders_kredisi"),
                        rs.getInt("ders_sinifi"),
                        rs.getInt("bolum_id"),
            ...
            Logger.getLogger(courses_gui_nA.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(courses_gui_nA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new courses_gui_nA().setVisible(true);
            }
        });
    }
